...
%ctor {
	...
	airplane_off = [[UIImage imageWithData:imageData] retain];
        imageData = [NSData dataWithContentsOfFile:@"/Library/UISettings/Icons/bluetooth.png"];
        bluetooth_on = [[UIImage imageWithData:imageData] retain];
        imageData = [NSData dataWithContentsOfFile:@"/Library/UISettings/Icons/no_bluetooth.png"];
	bluetooth_off = [[UIImage imageWithData:imageData] retain];
